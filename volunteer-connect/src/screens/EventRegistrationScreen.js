...
const EventRegistrationScreen = ({ route, navigation }) => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const userId = await AsyncStorage.getItem('userId'); // Get user ID directly
      ...
      const response = await fetch(`${API_URL}/events/${eventId}/register`, {
        ...
        body: JSON.stringify({
          volunteerId: userId, // Use the stored user ID
          message,
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.label}>Why do you want to volunteer for this event?</Text>
      <TextInput
        style={[styles.input, styles.textArea]}
        placeholder="Your motivation message"
        value={message}
      ...
      <Text style={styles.label}>Relevant Skills (comma separated)</Text>
      <TextInput
        style={styles.input}
